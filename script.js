    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "ITRAVELJERUSALEM משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '53d87e4b-fe9a-4f01-bd59-79200dc08ee1',
                    name: data.name || '',
                    email: data.email || '',
